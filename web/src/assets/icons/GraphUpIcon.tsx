interface GraphUpIconProps {
    color: string;
    width: number;
    height: number;
}

export default function GraphUpIcon(props : GraphUpIconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} fill={props.color} viewBox="0 0 16 16">
